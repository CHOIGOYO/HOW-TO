...
<div class="container text-center">
	<a href="#"> <img src="../img/QnA_bar.png" class="img-rounded img-responsive" alt="QnA_bar"></a>
	<table class="table table-responsive-sm">
		<thead>
            <tr>
              <th>궁금한 거 있으면 언제든 질문 주세요.</th>
            </tr>
		</thead>
	</table>
</div>
...
<div class = "container">
	<div class = "row">
		<div class = "col-2">1<input class = "btn btn-outline-none">
